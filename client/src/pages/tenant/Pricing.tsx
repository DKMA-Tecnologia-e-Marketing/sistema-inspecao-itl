    ...
    <TenantLayout>
      <div className="space-y-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Precificação</h2>
            <p className="text-muted-foreground">
              Ajuste os valores praticados respeitando as faixas definidas pelo administrador.
            </p>
          </div>
          <Button
            variant="outline"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Informe o valor desejado dentro da faixa permitida. O valor base é definido pela plataforma e você pode
              variar dentro do limite estipulado.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {!user?.tenantId ? (
              <p className="py-12 text-center text-muted-foreground">Carregando informações do estabelecimento...</p>
              ...
              <p className="py-12 text-center text-muted-foreground">
                Nenhum tipo de inspeção configurado para este estabelecimento.
              </p>
            ) : (
