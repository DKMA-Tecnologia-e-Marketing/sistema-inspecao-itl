...
class SDKServer {
  ...
  async createSessionToken(
    ...
    // Em desenvolvimento, usar appId padrão se não estiver configurado
    const appId = ENV.appId || "dev-local-app";
  ...
  async verifySession(
    ...
    try {
      ...
      // Em desenvolvimento, permitir appId vazio ou usar padrão
      const validAppId = ENV.isProduction ? appId : (appId || "dev-local-app");
      
      if (
        !isNonEmptyString(openId) ||
        !isNonEmptyString(validAppId) ||
